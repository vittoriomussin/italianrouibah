...
function CodeRoutineRoutineBegin(snapshot) {
  return async function () {
    ...
    CodeRoutineComponents.forEach( function(thisComponent) {
...
function SemanticCategoryRoutineBegin(snapshot) {
  return async function () {
    ...
    SemanticCategoryComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function ThanksRoutineRoutineBegin(snapshot) {
  return async function () {
    ...
    ThanksRoutineComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
